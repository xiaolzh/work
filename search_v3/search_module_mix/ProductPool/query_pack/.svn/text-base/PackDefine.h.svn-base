...
const char* const FILT_CUSTOM_DISCOUNT  = "-discount";
...
const char* const FILT_CUSTOM_SCORE     ="-score";
const char* const FILT_PRODUCT_BIT     ="-product_bit";
const char* const PRODUCT_BIT           ="product_bit";
const char* const PRODUCT_FLAG          ="product_flag";
const char* const MY_CAT_CUSTOM_GROUP   ="-cat_paths";
...
const int CUSTOM_SCORE_FILT             = 12;
const int PRODUCT_BIT_FILT             = 13;
const int FILT_DISCOUNT				   = 25;
