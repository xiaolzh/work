...
class CSearchKeyRanking:public CModule
{
	public:
		...
		//得到品牌的类别反馈权重
		void GetFeedBackBrandCateWeight(int docId,CDDAnalysisData* pa, int& fbBrandCateWeight);
		...
		//bool AdjustScoreByForceQueryPidFile(const string& query,vector<SResult>& vRes);
		//强制单品关联
		...
		bool ReduceNoImageProductScore(vector<SResult>& vRes);
		/*
	...
	private:
		...
		static const int CommerceFactor = 100000;
		...
		static const int Weight_BrandAppendScore = 150;   //品牌排序附加权重
		// 去除商业因素
	...
	private:
		...
		int CATALOG;
		//int TMinNum;    //主区字段最小编号
		int PTITLE_FID;                  //记录title的fieldID
