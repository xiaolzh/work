...
void CSearchKeyRanking::ComputeWeightOther(CDDAnalysisData* pa, SMatchElement& me, SResult& rt)
{
	rt.nDocId = me.id;
	rt.nWeight = 0;
	rt.nScore = 0;
	...
	{
#ifdef DEBUG
		cout<<"BrandQRank"<<endl;
#endif
		BrandQRank(pa, me, rt);	//计算品牌词查询权重
	}
	else if(1 == me.vTerms.size())
	{
#ifdef DEBUG
		cout<<"SingleRank"<<endl;
#endif
		SingleRank(pa, me, rt);	//计算单个词查询权重
	}
	else
	{
#ifdef DEBUG
...
void CSearchKeyRanking::BrandQRank(CDDAnalysisData* pa, SMatchElement& me, SResult& rt)
{
	...
	*/
	...
	ComputeCommerceWeight(rt.nDocId, salAmtScr, ifPub, salNumScr, salPreScr, ifHavImg, commentScr);
...
void CSearchKeyRanking::SingleRank(CDDAnalysisData* pa, SMatchElement& me, SResult& rt)
{
	...
	ComputeSpecialWeight(rt.nDocId, pa, fbCateScr, fbPidScr, pdtCoreScr, relSpeScr);
	//rt.nWeight += relSpeScr * RelIndicator;
...
void CSearchKeyRanking::ComputeSpecialWeight(const int docId, CDDAnalysisData* pa, 
...
void CSearchKeyRanking::ComputeCommerceWeight(const int docId, int& salAmtScr, int& ifPub, 
...
#ifdef DEBUG
	if(ifPub != 0)
		cout << "ComputeCommerceWeight::ifPub: " << ifPub << endl;
#endif
...
void CSearchKeyRanking::ChangeWeight(SResult& rt, CDDAnalysisData* pa)
//void CSearchKeyRanking::ChangeWeight(SResult& rt)
{
...
#ifdef DEBUG
	cout<<"ChangeWeight::modDays: " << modDays << endl;
#endif
