...
static const char* g_ShowTypeCaption[]={"xml","html","x-json"};
...
#endif
{
	...
	{		
		...
		int sType=(*pHandler)(strRec,strSnd);     
		if(sType<XML_TYPE || sType>JSON_TYPE)
			sType=HTML_TYPE;
		...
		sprintf(chHttpHeader,   "HTTP/1.1 200 OK\r\n"
			...
			"Content-Length: %d\r\n\r\n",g_ShowTypeCaption[sType], strSnd.length());
